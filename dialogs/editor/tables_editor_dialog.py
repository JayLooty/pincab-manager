...
class TablesEditorDialog:
    ...
    def __run_create_table(self):
        ...
        csv_items.append({
            ...
            Constants.CSV_COL_ALT_EXE: self.__current_csv_item[Constants.CSV_COL_ALT_EXE],
            Constants.CSV_COL_ALT_RUN_MODE: self.__current_csv_item[Constants.CSV_COL_ALT_RUN_MODE],
